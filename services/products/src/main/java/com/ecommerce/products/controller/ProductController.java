...
public class ProductController {
    ...
    public ResponseEntity<List<ProductPurchaseDTO>> purchaseProducts(@RequestBody @Valid List<ProductPurchaseRequest> productRequests) {
        return ResponseEntity.ok(productService.purchaseProduct(productRequests));
    }
